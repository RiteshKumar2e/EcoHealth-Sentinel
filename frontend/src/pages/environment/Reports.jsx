...
export default function Reports() {
  ...
  const handleGenerateReport = () => {
    try {
      ...
      doc.setFontSize(28);
      doc.setTextColor(255, 255, 255);
      doc.text('EcoAnalytics Custom Report', 20, 25);
      ...
      doc.autoTable({
        ...
        body: quickStats.map(s => [s.label, s.value, '90%', 'Upward']),
        styles: { fontSize: 9 },
      ...
      doc.text('Generated by EcoHealth Sentinel AI Engine', pageWidth / 2, pageHeight - 10, { align: 'center' });

      doc.save(`custom_analytics_report_${Date.now()}.pdf`);
      ...
      <div className="container-wrapper">
        ...
        <div className="header-card">
          <div className="header-content">
            ...
            <div className="flex-center gap-8" style={{ position: 'relative' }}>
              ...
              {showNotifications && (
                <div className="reports-notifications-dropdown">
